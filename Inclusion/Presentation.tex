...
\subsection{Equipe} % (fold) \label{sub:subsection_name}
...
% TODO Add logo playboy spot <<Playboy-Spots>> est un projet sur iPhone. Ce projet est annoncé part <<1663sa>>. Nous allons travailler avec <<1663sa>>, eux, ils font des design, nous faisons l'application sur iPhone. 
...
% subsection Introduciton au stage (end) % chapter Présentation (end)